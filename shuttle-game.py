...
#Loading
gameOverSound = pygame.mixer.Sound('audio/crash.wav')
pygame.mixer.music.load('audio/music.ogg')
laugh = pygame.mixer.Sound('audio/laugh.wav')
playerImage = pygame.image.load('images/shuttle.png')
planet1 = pygame.image.load('images/black.png')
planet2 = pygame.image.load('images/pluto.png')
planet3 = pygame.image.load('images/satan.png')
planet4 = pygame.image.load('images/jupiter.png')
playerRect = playerImage.get_rect()
baddieImage = pygame.image.load('images/satan.png')
sample = [planet1,planet2,planet3,planet4,baddieImage]
wallLeft = pygame.image.load('images/sides.png')
wallRight = pygame.image.load('images/sides.png')
